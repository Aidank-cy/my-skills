...
Implement improvements from a usability audit. Use this after an audit has already been done.

## Required Reading

Before starting, read:
1. The main frontend design audit skill — Workflow and principles
...
1. Ask: "I don't have an audit to work from. Would you like me to run one first, or do you have specific issues you'd like me to address?"
