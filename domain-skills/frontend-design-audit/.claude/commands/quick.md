...
1. The main frontend design audit skill — Framework and evaluation process
2. `references/heuristics.md` — What to look for
3. `references/patterns.md` — Fix patterns

## Usage

Ask the agent to run a quick audit across the project, a specific directory, or a specific file.
